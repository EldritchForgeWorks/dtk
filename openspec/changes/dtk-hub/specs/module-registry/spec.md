...
The module registry is the catalog contract — the shape of DTK module manifest entries
as stored in the remote JSON registry file and in world settings cache. It is consumed
by the installer UI and update checker.
