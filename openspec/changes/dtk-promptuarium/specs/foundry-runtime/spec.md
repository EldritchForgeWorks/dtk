# Spec: foundry-runtime

The Foundry runtime face of dtk-promptuarium is a thin Foundry module that exposes
`PromptariumApi.validate()` for runtime Exemplar schema validation. It has no CLI
functionality and no Node.js-only dependencies.
