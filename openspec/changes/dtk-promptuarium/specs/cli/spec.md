...
The `promptuarium` CLI is the primary interface for game system authors. It reads
config from `promptuarium.config.yaml` and provides three subcommands: `compile`,
