# Spec: combat-integration

dtk-alea integrates with Foundry's combat system by listening to existing hooks and
persisting state in Combat flags. It never replaces or subclasses any Foundry combat
class.
