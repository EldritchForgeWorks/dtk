...
The installer UI is the GM-facing ApplicationV2 window for browsing the DTK module
catalog, viewing installed vs. available versions, and triggering Foundry's native
module installer for specific modules.
